# This migration comes from bookshelf (originally 20140924102001)
class CreateBookshelfOwnerships < ActiveRecord::Migration
  def change
    ...
    add_index(:bookshelf_ownerships, [:people_user_id, :library_book_id], :unique => true, :name => "udx_people_books")
  end
end
